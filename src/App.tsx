          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="bg-emerald-50 hover:bg-emerald-100 text-emerald-600 border border-emerald-200 rounded-xl p-2.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-bold transition-all flex items-center justify-center gap-1.5 hover:shadow-sm shrink-0"
                title="Connect with WhatsApp Agent"
              >
                ...
                <span className="hidden md:inline text-emerald-800">WhatsApp Agent</span>
              </a>
